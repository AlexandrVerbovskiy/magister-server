...
exports.up = function (knex) {
  return knex.schema.createTable(STATIC.TABLES.TEMP_ORDERS, function (table) {
    ...
    table.integer("dispute_probability").nullable().defaultTo(null);
  });
};
...
exports.down = function (knex) {
  return knex.schema.dropTableIfExists(STATIC.TABLES.TEMP_ORDERS);
};
